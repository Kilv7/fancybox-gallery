!(function (e, t) {
                  ...
                  ? ((i =
                        -(r = (function _getCTM(e) {
                            var t,
                                n = e.getCTM();
                            return (
                                n || ((t = e.style[v]), (e.style[v] = "none"), e.appendChild(m), (n = m.getCTM()), e.removeChild(m), t ? (e.style[v] = t) : e.style.removeProperty(v.replace(/([A-Z])/g, "-$1").toLowerCase())),
                                n || x.clone()
                            );
                        })(e)).e / r.a),
                    (a = -r.f / r.d),
  ...
  function Na(e) {
      if (e === xe)
          return (
              ...
              (u.height = u.bottom = (e.innerHeight || 0) - 20 < ye.clientHeight ? ye.clientHeight : e.innerHeight || l.clientHeight || 0),
              u
          );
      var t = e.ownerDocument || me,
          n = Z(e.pageX) ? (e.nodeType || Z(e.left) || Z(e.top) ? be(e)[0].getBoundingClientRect() : e) : { left: e.pageX - Ea(t), top: e.pageY - Da(t), right: e.pageX - Ea(t) + 1, bottom: e.pageY - Da(t) + 1 };
      return (
          Z(n.right) && !Z(n.width) ? ((n.right = n.left + n.width), (n.bottom = n.top + n.height)) : Z(n.width) && (n = { width: n.right - n.left, height: n.bottom - n.top, right: n.right, left: n.left, bottom: n.bottom, top: n.top }), n
      );
  }
  function Oa(e, t, n) {
      var o,
  ...
  function Pa(e, t) {
      ...
      return i.nodeType || i === xe
          ? R(i, t)
          : Z(e.left)
          ? { left: (o = e.min || e.minX || e.minRotation || 0), top: (n = e.min || e.minY || 0), width: (e.max || e.maxX || e.maxRotation || 0) - o, height: (e.max || e.maxY || 0) - n }
  ...
  function Ua(e, t) {
      for (var n, o = e.length; o--; ) ((n = e[o]).ondragstart = n.onselectstart = t ? null : $), ge.set(n, { lazy: !0, userSelect: t ? "text" : "none" });
  }
  function Ya(i, r) {
      ...
      var a,
          ...
          w = 0,
          b = 0;
      P && !1 !== r.force3D ? ((c = "translate3d("), (d = "px,0px)")) : _ && ((c = "translate("), (d = "px)")),
          ...
          (this.left = function (e, t) {
              ...
              var n = i.scrollLeft - x,
                  o = f;
              if ((2 < n || n < -2) && !t) return (x = i.scrollLeft), ge.killTweensOf(this, { left: 1, scrollLeft: 1 }), this.left(-x), void (r.onKill && r.onKill());
              (e = -e) < 0 ? ((f = (e - 0.5) | 0), (e = 0)) : w < e ? ((f = (e - w) | 0), (e = w)) : (f = 0),
                  (f || o) && (this._skip || (p[_] = c + -f + "px," + -h + d), 0 <= f + v && (p.paddingRight = f + v + "px")),
                  (i.scrollLeft = 0 | e),
                  (x = i.scrollLeft);
          }),
          (this.top = function (e, t) {
              ...
              var n = i.scrollTop - g,
                  o = h;
              if ((2 < n || n < -2) && !t) return (g = i.scrollTop), ge.killTweensOf(this, { top: 1, scrollTop: 1 }), this.top(-g), void (r.onKill && r.onKill());
              (e = -e) < 0 ? ((h = (e - 0.5) | 0), (e = 0)) : b < e ? ((h = (e - b) | 0), (e = b)) : (h = 0), (h || o) && (this._skip || (p[_] = c + -f + "px," + -h + d)), (i.scrollTop = 0 | e), (g = i.scrollTop);
          }),
          ...
          (this.calibrate = function (e) {
              ...
              (g = i.scrollTop),
                  (x = i.scrollLeft),
                  (r && i.clientHeight === l && u.offsetHeight === s && m === i.scrollWidth && y === i.scrollHeight && !e) ||
                      ((h || f) && ((n = this.left()), (o = this.top()), this.left(-i.scrollLeft), this.top(-i.scrollTop)),
                      (t = La(i)),
                      (r && !e) || ((p.display = "block"), (p.width = "auto"), (p.paddingRight = "0px"), (v = Math.max(0, i.scrollWidth - i.clientWidth)) && (v += parseFloat(t.paddingLeft) + (k ? parseFloat(t.paddingRight) : 0))),
  ...
  function Za(e) {
      if (V() && document.body) {
          ...
          (xe = window),
              ...
              ((ve = da("div")).style.cssText = "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;cursor:grab"),
              (Se = "grab" === ve.style.cursor ? "grab" : "move"),
              (Xe = t && -1 !== t.userAgent.toLowerCase().indexOf("android")),
              (Te = ("ontouchstart" in ye && "orientation" in xe) || (t && (0 < t.MaxTouchPoints || 0 < t.msMaxTouchPoints))),
              (o = da("div")),
              (r = da("div")),
              (i = r.style),
              (a = l),
              ...
              (De = (function (e) {
                  for (
                      var t = e.split(","),
                          n = (("onpointerdown" in s) ? "pointerdown,pointermove,pointerup,pointercancel" : ("onmspointerdown" in s) ? "MSPointerDown,MSPointerMove,MSPointerUp,MSPointerCancel" : e).split(","),
                          o = {},
                          r = 4;
                      -1 < --r;
  ...
  var ge,
      ...
      R = function _getElementBounds(e, t) {
          ...
          if (e === xe)
              (r = Da(m)),
                  (o = (n = Ea(m)) + (m.documentElement.clientWidth || e.innerWidth || m.body.clientWidth || 0)),
                  (i = r + ((e.innerHeight || 0) - 20 < m.documentElement.clientHeight ? m.documentElement.clientHeight : e.innerHeight || m.body.clientHeight || 0));
          else {
              if (t === xe || Z(t)) return e.getBoundingClientRect();
              (n = r = 0),
                  x
                      ? ((p = (u = e.getBBox()).width), (h = u.height))
                      : (e.viewBox && (u = e.viewBox.baseVal) && ((n = u.x || 0), (r = u.y || 0), (p = u.width), (h = u.height)),
                        p ||
                            ((u = "border-box" === (f = La(e)).boxSizing),
                            (p = (parseFloat(f.width) || e.clientWidth || 0) + (u ? 0 : parseFloat(f.borderLeftWidth) + parseFloat(f.borderRightWidth))),
                            (h = (parseFloat(f.height) || e.clientHeight || 0) + (u ? 0 : parseFloat(f.borderTopWidth) + parseFloat(f.borderBottomWidth))))),
                  (o = p),
                  (i = h);
          }
          return e === t
              ...
              : ((l = (a = getGlobalMatrix(t, !0).multiply(getGlobalMatrix(e))).apply({ x: n, y: r })),
                ...
                { left: n + ((g = t.parentNode || {}).scrollLeft || 0), top: r + (g.scrollTop || 0), width: Math.max(l.x, s.x, c.x, d.x) - n, height: Math.max(l.y, s.y, c.y, d.y) - r });
      },
      B =
          ...
          (Draggable.hitTest = function hitTest(e, t, n) {
              ...
              return f || !n
                  ...
                  : ((i = -1 !== (n + "").indexOf("%")),
                    ...
                    !(o.width < 0 || o.height < 0) && (i ? p * h * (n *= 0.01) <= (r = o.width * o.height) || r >= l.width * l.height * n : o.width > n && o.height > n));
          }),
          Draggable);
  function Draggable(h, u) {
      ...
      function vh(e) {
          if (J.autoScroll && J.isDragging && (ee || O)) {
              ...
              for (
                  ee = !1,
                      He.scrollTop = null != xe.pageYOffset ? xe.pageYOffset : null != ce.documentElement.scrollTop ? ce.documentElement.scrollTop : ce.body.scrollTop,
                      He.scrollLeft = null != xe.pageXOffset ? xe.pageXOffset : null != ce.documentElement.scrollLeft ? ce.documentElement.scrollLeft : ce.body.scrollLeft,
                  ...
                  (t = (n = Fe(c.parentNode)) ? He : c.parentNode),
                      ...
                      $ &&
                          ((s = t._gsMaxScrollY - t.scrollTop) < 0
                              ...
                              : i < o.top + te && t.scrollTop && ((ee = !0), (l = -Math.min(t.scrollTop, (d * (1 - Math.max(0, i - o.top) / te)) | 0))),
                          l && (t.scrollTop += l)),
                      U &&
                          ((s = t._gsMaxScrollX - t.scrollLeft) < 0
                              ...
                              : r < o.left + re && t.scrollLeft && ((ee = !0), (a = -Math.min(t.scrollLeft, (d * (1 - Math.max(0, r - o.left) / re)) | 0))),
                          a && (t.scrollLeft += a)),
                      n && (a || l) && (xe.scrollTo(t.scrollLeft, t.scrollTop), pe(J.pointerX + a, J.pointerY + l)),
                      (c = t);
          }
          if (O) {
              var u = J.x,
                  p = J.y;
              G
                  ? ((J.deltaX = u - parseFloat(le.rotation)), (J.rotation = u), (le.rotation = u + "deg"), le.renderTransform(1, le))
                  : f
                  ? ($ && ((J.deltaY = p - f.top()), f.top(p)), U && ((J.deltaX = u - f.left()), f.left(u)))
                  : W
                  ? ($ && ((J.deltaY = p - parseFloat(le.y)), (le.y = p + "px")), U && ((J.deltaX = u - parseFloat(le.x)), (le.x = u + "px")), le.renderTransform(1, le))
                  : ($ && ((J.deltaY = p - parseFloat(h.style.top || 0)), (h.style.top = p + "px")), U && ((J.deltaX = u - parseFloat(h.style.left || 0)), (h.style.left = u + "px"))),
                  !g || e || H || (!(H = !0) === Oa(J, "drag", "onDrag") && (U && (J.x -= J.deltaX), $ && (J.y -= J.deltaY), vh(!0)), (H = !1));
          }
          O = !1;
      }
      function wh(e, t) {
          ...
          h._gsap || (le = ge.core.getCache(h)),
              ...
              W
                  ...
                  : ((J.y = parseFloat(h.style.top || ((o = La(h)) && o.top)) || 0), (J.x = parseFloat(h.style.left || (o || {}).left) || 0)),
              (P || k || _) &&
                  !t &&
                  (J.isDragging || J.isThrowing) &&
                  (_ && ((Ie.x = J.x), (Ie.y = J.y), (n = _(Ie)).x !== J.x && ((J.x = n.x), (O = !0)), n.y !== J.y && ((J.y = n.y), (O = !0))),
      ...
      function zh() {
          ...
          (E = !1),
              f
                  ? (f.calibrate(), (J.minX = L = -f.maxScrollLeft()), (J.minY = C = -f.maxScrollTop()), (J.maxX = M = J.maxY = S = 0), (E = !0))
                  : u.bounds &&
                    ((e = Pa(u.bounds, h.parentNode)),
                    G
                        ? ((J.minX = L = e.left), (J.maxX = M = e.left + e.width), (J.minY = C = J.maxY = S = 0))
                        ...
                        : ((e = u.bounds), (J.minX = L = e.minX), (J.minY = C = e.minY), (J.maxX = M = e.maxX), (J.maxY = S = e.maxY)),
              ...
              u.liveSnap &&
                  ...
                  G
                                ...
                                X(s)
                                    ? function (e) {
                                          ...
                                          return (
                                              ...
                                              1 !== h && ((e.x *= h), (e.y *= h)),
                                              p < Pe && ((n = e.x - i), (o = e.y - a), p < n * n + o * o && ((e.x = i), (e.y = a))),
                                              e
                                          );
                                      }
                                    : Ne(s)
                      ...
                      : (U && (P = xh(o ? n : n.x || n.left || n.scrollLeft, L, M, f ? -1 : 1)), $ && (k = xh(o ? n : n.y || n.top || n.scrollTop, C, S, f ? -1 : 1))));
      }
      function Ah() {
          ...
          e && Le
              ? (!0 === e &&
                    ...
                    G
                        ...
                        : (U && (e[K] = Sa(J, o ? n : n.points || n.x || n.left, M, L, f ? -1 : 1, t || "x" === J.lockedAxis)),
                          $ && (e[V] = Sa(J, o ? n : n.points || n.y || n.top, S, C, f ? -1 : 1, t || "y" === J.lockedAxis)),
                          (n.points || (Ne(n) && Y(n[0]))) && ((e.linkedProps = K + "," + V), (e.radius = n.radius)))),
                (J.isThrowing = !0),
                (i = isNaN(u.overshootTolerance) ? (1 === u.edgeResistance ? 0 : 1 - J.edgeResistance + 0.2) : u.overshootTolerance),
                e.duration || (e.duration = { max: Math.max(u.minDuration || 0, "maxDuration" in u ? u.maxDuration : 2), min: isNaN(u.minDuration) ? (0 === i || (Y(e) && 1e3 < e.resistance) ? 0 : 0.5) : u.minDuration, overshoot: i }),
                (J.tween = r = ge.to(f || h, {
                    inertia: e,
                    data: "_draggable",
                    onComplete: Ah,
                ...
                u.fastMode || (f && (f._skip = !0), r.render(1e9, !0, !0), wh(!0, !0), (J.endX = J.x), (J.endY = J.y), G && (J.endRotation = J.x), r.play(0), wh(!0, !0), f && (f._skip = !1)))
              : E && J.applyBounds();
      }
      function Dh(e) {
          var t,
          ...
          Dh(!1),
              ...
              f
                  ...
                  : (de() ? (wh(!0, !0), zh()) : J.applyBounds(),
                    G
                        ? ((e = h.ownerSVGElement ? [le.xOrigin - h.getBBox().x, le.yOrigin - h.getBBox().y] : (La(h)[Ce] || "0 0").split(" ")),
                          (N = J.rotationOrigin = getGlobalMatrix(h).apply({ x: parseFloat(e[0]) || 0, y: parseFloat(e[1]) || 0 })),
                          wh(!0, !0),
                          (t = J.pointerX - N.x - r),
                          (n = N.y - J.pointerY + i),
                          (T = J.x),
                        ...
                        : ((D = Og(V, "px")), (T = Og(K, "px")))),
              E && o && (M < T ? (T = M + (T - M) / o) : T < L && (T = L - (L - T) / o), G || (S < D ? (D = S + (D - S) / o) : D < C && (D = C - (C - D) / o))),
              (J.startX = T = ba(T)),
              (J.startY = D = ba(D));
      }
      function Gh() {
      ...
      function Hh(e, t) {
          ...
          if (!p || J.isPressed || !e || (!(("mousedown" !== e.type && "pointerdown" !== e.type) || t) && ke() - ae < 30 && De[J.pointerEvent.type])) z && e && p && za(e);
              ...
              if (
                  ((A = de()),
                  (J.pointerEvent = e),
                  De[e.type] ? ((v = ~e.type.indexOf("touch") ? e.currentTarget || e.target : ce), xa(v, "touchend", he), xa(v, "touchmove", ue), xa(v, "touchcancel", he), xa(ce, "touchstart", Ca)) : ((v = null), xa(ce, "mousemove", ue)),
                  (I = null),
                  (Ye && v) || (xa(ce, "mouseup", he), e && e.target && xa(e.target, "mouseup", he)),
                  (y = ie.call(J, e.target) && !1 === u.dragClickables && !t))
              )
                  return xa(e.target, "change", he), Oa(J, "pressInit", "onPressInit"), Oa(J, "press", "onPress"), Ua(q, !0), void (z = !1);
              if (
                  ((B = !(!v || U == $ || !1 === J.vars.allowNativeTouchScrolling || (J.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which))) && (U ? "y" : "x")),
                  ...
                  !h.parentNode || !J.autoScroll || f || G || !h.parentNode._gsMaxScrollX || ve.parentNode || h.getBBox || ((ve.style.width = h.parentNode.scrollWidth + "px"), h.parentNode.appendChild(ve)),
                  Eh(),
                  ...
                  (!u.zIndexBoost && (G || f || !1 === u.zIndexBoost)) || (h.style.zIndex = Draggable.zIndex++),
                  (J.isPressed = !0),
      ...
      function Mh(e) {
          ...
          if (((r || (o && !1 !== J.vars.suppressClickOnDrag)) && e.stopImmediatePropagation && e.stopImmediatePropagation(), n && (!J.pointerEvent || !J.pointerEvent.defaultPrevented) && (!r || (l && !a))))
      ...
      var p,
          ...
          ue = function onMove(e) {
              ...
              if (p && !Me && J.isPressed && e) {
                  ...
                  (n = ze.x),
                  (o = ze.y),
                  (((i = Math.abs(n - w)) !== (a = Math.abs(o - b)) && (j < i || j < a)) || (Xe && B === I)) &&
                      ((I = a < i && U ? "x" : "y"),
                      B && I !== B && xa(xe, "touchforcechange", za),
                      !1 !== J.vars.lockAxisOnTouchScroll && U && $ && ((J.lockedAxis = "x" === I ? "y" : "x"), X(J.vars.onLockAxis) && J.vars.onLockAxis.call(J, l)),
                      Xe && B === I))
                      ? he(l)
                      : ((z = J.allowEventDefault || (B && (!I || B === I)) || !1 === l.cancelable ? z && !1 : (za(l), !0)), J.autoScroll && (ee = !0), pe(e.pageX, e.pageY, s));
              } else z && e && p && za(e);
          },
          pe = function setPointerPosition(e, t, n) {
              ...
              (J.pointerX = e),
                  ...
                  se && ((e -= Ea(ce)), (t -= Da(ce))),
                  G
                      ? ((a = Math.atan2(N.y - t, e - N.x) * Oe), 180 < (l = J.y - a) ? ((D -= 360), (J.y = a)) : l < -180 && ((D += 360), (J.y = a)), (i = J.x !== T || Math.abs(D - a) > j ? ((J.y = a), T + (D - a) * c) : T))
                      : (R && ((s = e * R.a + t * R.c + R.e), (t = e * R.b + t * R.d + R.f), (e = s)),
                        (r = t - b) < j && -j < r && (r = 0),
                        (o = e - w) < j && -j < o && (o = 0),
                        (J.lockAxis || J.lockedAxis) &&
                            (o || r) &&
                            ((s = J.lockedAxis) || ((J.lockedAxis = s = U && Math.abs(o) > Math.abs(r) ? "y" : $ ? "x" : null), s && X(J.vars.onLockAxis) && J.vars.onLockAxis.call(J, J.pointerEvent)),
                            "y" === s ? (r = 0) : "x" === s && (o = 0)),
                        (i = ba(T + o * c)),
                        (a = ba(D + r * c))),
                  (P || k || _) && (J.x !== i || (J.y !== a && !G)) && (_ && ((Ie.x = i), (Ie.y = a), (s = _(Ie)), (i = ba(s.x)), (a = ba(s.y))), P && (i = ba(P(i))), k && (a = ba(k(a)))),
                  E && (M < i ? (i = M + Math.round((i - M) * d)) : i < L && (i = L + Math.round((i - L) * d)), G || (S < a ? (a = Math.round(S + (a - S) * d)) : a < C && (a = Math.round(C + (a - C) * d)))),
                  (J.x === i && (J.y === a || G)) ||
                      (G ? ((J.endRotation = J.x = J.endX = i), (O = !0)) : ($ && ((J.y = J.endY = a), (O = !0)), U && ((J.x = J.endX = i), (O = !0))),
                      n && !1 === Oa(J, "move", "onMove")
                          ? ((J.pointerX = u), (J.pointerY = p), (D = h), (J.x = f), (J.y = g), (J.endX = x), (J.endY = m), (J.endRotation = y), (O = v))
                          : !J.isDragging && J.isPressed && ((J.isDragging = !0), Oa(J, "dragstart", "onDragStart")));
          },
          he = function onRelease(e, t) {
              if (
                  ...
                  if (
                      (v ? (ya(v, "touchend", onRelease), ya(v, "touchmove", ue), ya(v, "touchcancel", onRelease), ya(ce, "touchstart", Ca)) : ya(ce, "mousemove", ue),
                      ya(xe, "touchforcechange", za),
                      (Ye && v) || (ya(ce, "mouseup", onRelease), e && e.target && ya(e.target, "mouseup", onRelease)),
                      (O = !1),
                      s && ((Q = Be = ke()), (J.isDragging = !1)),
                      y && !c)
                  )
                      return e && (ya(e.target, "change", onRelease), (J.pointerEvent = l)), Ua(q, !1), Oa(J, "release", "onRelease"), Oa(J, "click", "onClick"), void (y = !1);
                                ...
                                (a = function syntheticClick() {
                                    ae === F ||
                                        ...
                                        (i.click
                                            ? i.click()
                                            : ce.createEvent &&
                                              ((r = ce.createEvent("MouseEvents")).initMouseEvent("click", !0, !0, xe, 1, J.pointerEvent.screenX, J.pointerEvent.screenY, J.pointerX, J.pointerY, !1, !1, !1, !1, 0, null),
                                              i.dispatchEvent(r)));
                                }),
                                Xe || l.defaultPrevented || ge.delayedCall(0.05, a)))
                          : (Ch(u.inertia || u.throwProps),
                            J.allowEventDefault || !l || (!1 === u.dragClickables && ie.call(J, l.target)) || !s || (B && (!I || B !== I)) || !1 === l.cancelable ? (z = !1) : ((z = !0), za(l)),
                            Oa(J, "release", "onRelease")),
      ...
      return (
          ...
          (e.startDrag = function (e, t) {
              ...
              Hh(e || J.pointerEvent, !0),
                  t &&
                      ...
                      ((n = Na(e || J.pointerEvent)), (o = Na(h)), (r = Nh({ x: n.left + n.width / 2, y: n.top + n.height / 2 })), (i = Nh({ x: o.left + o.width / 2, y: o.top + o.height / 2 })), (w -= r.x - i.x), (b -= r.y - i.y)),
          ...
          (e.getDirection = function (e, t) {
              ...
              return (
                  ...
                  (n = "start" === s ? J.x - T : "velocity" === s ? Le.getVelocity(h, K) : a.left + a.width / 2 - (l.left + l.width / 2)),
                  G
                      ? n < 0
                          ? "counter-clockwise"
                          : "clockwise"
                      : ((t = t || 2),
                        (o = "start" === s ? J.y - D : "velocity" === s ? Le.getVelocity(h, V) : a.top + a.height / 2 - (l.top + l.height / 2)),
          ...
          (e.applyBounds = function (e, t) {
              ...
              if ((wh(!0), zh(), E && !de())) {
                  if (
                      ...
                      M < n ? (n = M) : n < L && (n = L),
                      S < o ? (o = S) : o < C && (o = C),
                      (J.x !== n || J.y !== o) && ((r = !0), (J.x = J.endX = n), G ? (J.endRotation = n) : (J.y = J.endY = o), vh((O = !0)), J.autoScroll && !J.isDragging))
                  )
                      for (
                          Ja(h.parentNode),
                              i = h,
          ...
          (e.update = function (e, t, n) {
              if (t && J.isPressed) {
                  ...
                  i.apply({ x: o.e - r.x, y: o.f - r.y }, r), (J.x -= r.x - i.e), (J.y -= r.y - i.f), vh(!0), Eh();
              }
              var a = J.x,
                  l = J.y;
              return (
                  ...
                  J.isPressed && !t && ((U && 0.01 < Math.abs(a - J.x)) || ($ && 0.01 < Math.abs(l - J.y) && !G)) && Eh(),
                  J.autoScroll && (Ja(h.parentNode, J.isDragging), (ee = J.isDragging), vh(!0), Ga(h, Lh), Fa(h, Lh)),
                  J
              );
          }),
          (e.enable = function (e) {
              ...
              if ((!1 !== u.cursor && (r.cursor = u.cursor || Se), ge.utils.checkPrefix("touchCallout") && (r.touchCallout = "none"), "soft" !== e)) {
                  for (
                      ra(q, U == $ ? "none" : (u.allowNativeTouchScrolling && (h.scrollHeight === h.clientHeight) == (h.scrollWidth === h.clientHeight)) || u.allowEventDefault ? "manipulation" : U ? "pan-y" : "pan-x"), n = q.length;
                      -1 < --n;
                      ...
                      (o = q[n]),
                          ...
                          xa(o, "click", Mh, !0),
                          ge.set(o, r),
                          o.getBBox && o.ownerSVGElement && ge.set(o.ownerSVGElement, { touchAction: U == $ ? "none" : u.allowNativeTouchScrolling || u.allowEventDefault ? "manipulation" : U ? "pan-y" : "pan-x" }),
          ...
          (e.kill = function () {
              return (J.isThrowing = !1), J.tween && J.tween.kill(), J.disable(), ge.set(q, { clearProps: "userSelect" }), delete Re[h._gsDragID], J;
          }),
          ~n.indexOf("scroll") &&
              ((f = e.scrollProxy = new Ya(
                  h,
  ...
  !(function _setDefaults(e, t) {
      for (var n in t) n in e || (e[n] = t[n]);
  })(I.prototype, { pointerX: 0, pointerY: 0, startX: 0, startY: 0, deltaX: 0, deltaY: 0, isDragging: !1, isPressed: !1 }),
      (I.zIndex = 1e3),
      (I.version = "3.10.4"),
